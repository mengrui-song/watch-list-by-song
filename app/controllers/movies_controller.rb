...
class MoviesController < ApplicationController
  ...
  def show
    ...
    authorize @movie
    @people = FetchPerson.person_data(@movie)
    @people_as_crew = FetchPerson.generate_people_as('crew', @people, @movie)
    @people_as_cast = FetchPerson.generate_people_as('cast', @people, @movie)
  end
